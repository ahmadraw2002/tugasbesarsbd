                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('mobils.index') }}">Manage Mobil</a></li>
                            <li><a class="nav-link" href="{{ route('pemiliks.index') }}">Nama Pemilik</a></li>
                            <li><a class="nav-link" href="/gabungan">List Mobil</a></li>
